...
public class XmlRpcServerClientConnectionServer extends XmlRpcHttpServer {
    protected void writeError(XmlRpcStreamRequestConfig config, OutputStream stream,
                              Throwable throwable) throws XmlRpcException {
    ...
    @Override
    protected void
    writeResponse(XmlRpcStreamRequestConfig config, OutputStream stream, Object result)
    ...
    @Override
    protected void setResponseHeader(ServerStreamConnection connection, String headerName,
                                     String headerValue) {
